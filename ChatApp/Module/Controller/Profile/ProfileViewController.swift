...
//  ChatApp
//
//  Created by Алеся Афанасенкова on 14.03.2026.
//
...
class ProfileViewController: UIViewController {
    ...
    private func configureUI() {
        ...
        tableView.anchor(top: profileImageView.bottomAnchor, left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, paddingTop: 25, paddingLeft: 30, paddingBottom: 25, paddingRight: 30)
